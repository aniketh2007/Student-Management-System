...
class student:
    def __init__(self,root):
        ...
        addbtn=Button(btn_frame,text='Add',width=10,fg="black",command=self.add_Students).grid(row=0,column=1,padx=10,pady=10)
        delbtn=Button(btn_frame,text='Delete',width=10,fg="black",command=self.delete_data).grid(row=0,column=2,padx=10,pady=10)
        updbtn=Button(btn_frame,text='Update',width=10,fg="black",command=self.update_Students).grid(row=0,column=3,padx=10,pady=10)
        clrbtn=Button(btn_frame,text='Clear',width=10,fg="black",command=self.clear).grid(row=0,column=4,padx=10,pady=10)
        ...
        search_btn=Button(detail_frame,text='Serach',command=self.search,width=15,height=1).grid(row=0,column=5,padx=10,pady=10)
        showall_btn=Button(detail_frame,text='Show All',command=self.fetch_data,width=15,height=1).grid(row=0,column=6,padx=10,pady=10)
